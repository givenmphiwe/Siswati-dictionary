...
public class idioms extends AppCompatActivity {
    ...
    private void fetchData() {
        ...
        Cursor cursor = sd.query("Idioms" ,null, null, null, null, null, null);
        li = cursor.getColumnIndex("firstidiom");
        wordcombinelist = new ArrayList<String>();
        meancombinelist = new ArrayList<String>();

        while (cursor.moveToNext()){
            namelist.put(cursor.getString(li), cursor.getString(cursor.getColumnIndex("idiom")));
        }
