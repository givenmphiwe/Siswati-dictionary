...
public class Defination extends AppCompatActivity {
    ...
    private void fetchData() {
        ...
        Cursor cursor = sd.query("Defination" ,null, null, null, null, null, null);
        li = cursor.getColumnIndex("word");
        wordcombinelist = new ArrayList<String>();
        meancombinelist = new ArrayList<String>();

        while (cursor.moveToNext()){
            namelist.put(cursor.getString(li), cursor.getString(cursor.getColumnIndex("defination")));
        }
