...
public class Translation extends AppCompatActivity {
    ...
    private void fetchData() {
        ...
        Cursor cursor = sd.query("English" ,null, null, null, null, null, null);
        li = cursor.getColumnIndex("siswati");
        wordcombinelist = new ArrayList<String>();
        meancombinelist = new ArrayList<String>();

        while (cursor.moveToNext()){
            namelist.put(cursor.getString(li), cursor.getString(cursor.getColumnIndex("english")));
        }
